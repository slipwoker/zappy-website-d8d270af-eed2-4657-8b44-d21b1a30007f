    ...
    contactForm.addEventListener('submit', function(e) {
      ...
      if (!window.zappyContactFormLoaded) {
        try {
          ...
          fetch('https://api.zappy5.com/api/email/contact-form', {
            method: 'POST',
            headers: { 'Content-Type': 'application/json' },
            body: JSON.stringify({
              websiteId: 'd8d270af-eed2-4657-8b44-d21b1a30007f',
              name: name,
              email: email,
          ...
          console.error('❌ Zappy: Exception while sending email', error);
        }
      }
    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "תחת השם הפרטי משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
